...
export const Todo = (props) => {
  ...
  <li className="todos__list__item x" onDoubleClick={() => props.toogleEditTodo(props.id)}>
    ...
    <button className="todos__list__item__delete x" onClick={() => props.deleteTodo(props.id)}>
      <svg className="todos__list__item__delete__icon x" enableBackground="new 0 0 212.982 212.982" version="1.1" viewBox="0 0 212.982 212.982" xmlns="http://www.w3.org/2000/svg">
        <g fill="#e74c3c">
